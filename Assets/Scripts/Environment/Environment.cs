...
public class Environment : MonoBehaviour {
    ...
    [Header ("Sponteneous Continuous Plant Growth")]
    ...
    IEnumerator plantSeeds(){
        ...
        SponteneousGeneration(plantPrefab);
    }*/
    ...
    void SpawnInitialPopulations () {
        ...
        var spawnPrng = new System.Random (seed); //stands for Pseudo-Random Number-Generator
    ...
    void SponteneousGeneration (Plant prefab) { //include organism as an argument
        var spawnPrng = new System.Random (seed);
        var spawnCoords = new List<Coord> (walkableCoords);
        //Debug.Log(spawnCoords.Count);
